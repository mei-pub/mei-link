...
export type Tunnel = { id:string; name:string; type:"http"|"https"|"tcp"|"udp"; localIP:string; localPort:number; subdomain?:string; remotePort?:number; enabled:boolean; status?:string; errorMessage?:string };
